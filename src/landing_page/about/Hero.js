    ...
    return ( 
        <div className='container p-5'>
            <div className='row text-center my-5'>
                <h1 className='fs-3'>We pioneered the discount broking model in India. <br /> Now, we are breaking ground with our technology.</h1>
            </div>
            <hr />
            <div className='row text-right my-5' style={{lineHeight:"1.8", fontSize:"1.2em", opacity:"0.9"}}>
                ...
                <div className='col-6 p-5 my-5'>
                    ...
                    <p>
                        <a href='abc.com' style={{textDecoration:"none"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.
                    </p>
                    <p>
