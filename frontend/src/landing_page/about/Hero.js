        ...
        <div className='container p-5'>
            ...
            <div className='row text-right my-5' style={{lineHeight:"1.8", fontSize:"1.2em", opacity:"0.9"}}>
                ...
                <div className='col-6 p-5 my-5'>
                    ...
                    <p>
                        <Link to='/Abc'>Rainmatter</Link>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.
                    </p>
                    <p>
